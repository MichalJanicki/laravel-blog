...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class='nav-item px-2'><a class='nav-link' href='{{route("binshopsblog.index")}}'>Blog
                                home</a></li>
    ...
    @if( config("binshopsblog.use_wysiwyg") && config("binshopsblog.echo_html") && (in_array(
    \Request::route()->getName() ,[ 'binshopsblog.admin.create_post' , 'binshopsblog.admin.edit_post' ])))
